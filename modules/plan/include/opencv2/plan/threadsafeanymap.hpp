#ifndef MODULES_PLAN_INCLUDE_OPENCV2_PLAN_THREADSAFEANYMAP_HPP_
#define MODULES_PLAN_INCLUDE_OPENCV2_PLAN_THREADSAFEANYMAP_HPP_
...
private:
    ...
    void check_write(K key) {
        CV_Assert(properties_.size() > static_cast<size_t>(key));
...
#endif // MODULES_PLAN_INCLUDE_OPENCV2_PLAN_THREADSAFEANYMAP_HPP_
